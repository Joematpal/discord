...
This repository contains the [protocol whitepaper](docs/dave-protocol.md) for Discord's Audio & Video End-to-End Encryption (DAVE) protocol. It is additionally viewable at [daveprotocol.com](https://daveprotocol.com).
